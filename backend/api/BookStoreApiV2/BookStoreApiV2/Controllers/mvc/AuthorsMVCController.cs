...
namespace BookStoreApiV2.Controllers.mvc
{
    public class AuthorsMVCController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "aId,aFName,aLName,aCountry")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "aId,aFName,aLName,aCountry")] Author author)
        {
            if (ModelState.IsValid)
            {
